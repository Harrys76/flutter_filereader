...
class _FileReaderViewState extends State<FileReaderView> {
  ...
  Widget _unSupportFile() {
    return widget.unSupportFileWidget ??
        Center(
          child: Text("Does not support opening${_fileType(filePath)}Type of file"),
        );
  }
  ...
  Widget _enginLoadFail() {
    ...
    // It is also possible that the download was successful the first time,
    // but the loading was unsuccessful
    return Center(
